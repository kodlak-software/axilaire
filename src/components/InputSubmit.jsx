...
const InputSubmit = (props) => {
    ...
    return (
        <div className={"w-full space-x-3 flex " + className}>
                ...
                <button type="button" className="py-3 px-7   text-sm font-medium rounded-lg border border-transparent bg-gray-900 transition-colors duration-300 transform text-white hover:bg-gray-700 focus:outline-hidden focus:bg-gray-900 disabled:opacity-50 disabled:pointer-events-none " >
                    button
                </button>
        </div>
    );
