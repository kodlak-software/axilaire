    ...
    <div className="container px-6 py-12 mx-auto">
        ...
        <div className="grid grid-cols-1 gap-12 mt-10 lg:grid-cols-2">
            <div className="grid grid-cols-1 gap-12 md:grid-cols-2">
                <div>
                    <span className="inline-block p-3 text-gray-500 rounded-full bg-red-100/80 dark:bg-gray-800">
                    ...
                    <p className="mt-2 text-sm text-gray-400  underline">hello@merakiui.com</p>
                </div>
                ...
                <div>
                    ...
                    <p className="mt-2 text-sm text-gray-500 dark:text-gray-400">Our friendly team is here to help.</p>
                    <p className="mt-2 text-sm text-gray-400  underline">Start new chat</p>
                </div>
                ...
                <div>
                    ...
                    <p className="mt-2 text-sm text-gray-400  underline">100 Smith Street Collingwood VIC 3066 AU</p>
                </div>
                ...
                <div>
                    ...
                    <p className="mt-2 text-sm text-gray-400  underline">+1 (555) 000-0000</p>
                </div>
            </div>
            ...
            <div className="p-4 py-6 rounded-lg bg-gray-50 dark:bg-gray-800 md:p-8">
                <form>
                    ...
                    <button className="w-full px-6 py-3 mt-4 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-gray-900 rounded-lg hover:bg-gray-700 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-50">
                        Send message
                    </button>
                </form>
            </div>
