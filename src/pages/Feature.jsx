    ...
    <div className="container px-6 py-10 mx-auto">
        ...
        <div className="grid grid-cols-1 gap-8 mt-8 xl:mt-12 xl:gap-16 md:grid-cols-2 xl:grid-cols-3">
            <div className="space-y-3">
                <span className="inline-block p-3 text-gray-500 bg-red-100 rounded-full dark:text-white dark:bg-gray-500">
                ...
                <a href="#" className="inline-flex items-center -mx-1 text-sm text-gray-500 capitalize transition-colors duration-300 transform dark:text-gray-400 hover:underline hover:text-gray-600 dark:hover:text-gray-500">
