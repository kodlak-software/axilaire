...
import fashion from '../media/img/fashion_1.png'

const Hero = () => {
    return (
        <header className="bg-white dark:bg-gray-900 my-16">
                ...
                <div className="items-center lg:flex">
                    <div className="w-full lg:w-1/2">
                        <div className="lg:max-w-lg">
                            ...
                            <InputSubmit placeholder="This is placeholder" className="mt-10" />
                            <p class="text-gray-400 ml-2 text-sm my-2">For more information <a href="" className="underline">see here</a></p>
                    ...
                    <div className="flex items-center justify-center w-full mt-6 lg:mt-0 lg:w-1/2">
                        <img className="w-full h-full lg:max-w-3xl rounded-md" src={fashion} alt="Catalogue-pana.svg" />
                    </div>
                </div>
            </div>
        </header>
