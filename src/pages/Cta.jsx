...
import phone from '../media/img/phone.png'

const Cta = () => {
    return (
        <section className=" dark:bg-gray-900 py-16 bg-gray-50">
            <div className="container flex flex-col items-center px-4 py-12 mx-auto xl:flex-row">
                <div className="flex justify-center xl:w-1/2">
                    <img className="h-80 w-80 sm:w-[28rem] sm:h-[28rem] flex-shrink-0 object-cover rounded-full" src={phone} alt="" />
                </div>
                ...
                <div className="flex flex-col items-center mt-6 xl:items-start xl:w-1/2 xl:mt-0">
                    ...
                    <div className="mt-6 sm:-mx-2">
                        <a href="#" className="inline-flex items-center justify-center w-full px-4 text-sm py-2.5 overflow-hidden text-white transition-colors duration-300 bg-gray-900 rounded-lg shadow sm:w-auto sm:mx-2 hover:bg-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700 focus:ring focus:ring-gray-300 focus:ring-opacity-80">
                            <svg className="w-5 h-5 mx-2 fill-current" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 512 512" >
                                <g>
                                    <g>
                        ...
                        <a href="#"
                            className="inline-flex items-center justify-center w-full px-4 text-sm py-2.5 mt-4 overflow-hidden text-white transition-colors duration-300 bg-gray-900 rounded-lg shadow sm:w-auto sm:mx-2 sm:mt-0 hover:bg-gray-700 focus:ring focus:ring-blue-300 focus:ring-opacity-80">
